  ...
  <div class="sidebar-wrapper scrollbar scrollbar-inner">
    <div class="sidebar-content">
        ...
        <div class="info">
          <a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
            <span>
              ...
              @if (empty(Auth::guard('user')->user()->role))
                <span class="user-level">Owner</span>
              @else
                <span class="user-level">{{Auth::guard('user')->user()->role}}</span>
              @endif
          ...
          <div class="collapse in" id="collapseExample">
            <ul class="nav">
              ...
              <li>
                <a href="{{route('admin.login-user.logout')}}">
      ...
      <ul class="nav nav-primary">
          ...
          {{-- Dashboard --}}
          <li class="nav-item @if(request()->path() == 'teacher/admin') active @endif">
