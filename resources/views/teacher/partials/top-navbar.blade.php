          ...
          <ul class="dropdown-menu dropdown-user animated fadeIn">
            <div class="dropdown-user-scroll scrollbar-outer">
              <li>
                <div class="user-box">
                  <div class="avatar-lg">
                    @if (!empty(Auth::guard('user')->user()->avatar_location))
                      <img src="{{asset('assets/admin/img/propics/'.Auth::guard('user')->user()->image)}}" alt="..." class="avatar-img rounded">
                    @else
                  ...
                  <div class="u-text">
                    ...
                    {{-- <p class="text-muted">{{Auth::guard('user')->user()->email}}</p><a href="{{route('admin.editProfile')}}" class="btn btn-xs btn-secondary btn-sm">Edit Profile</a> --}}
                  </div>
                </div>
              </li>
              <li>
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{route('admin.login-user.logout')}}">Logout</a>
              </li>
            </div>
          </ul>
        </li>
