...
@section('content')
  ...
  <div class="quote-area">
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <form action="{{route('hello')}}" enctype="multipart/form-data" method="POST">
            @csrf
          ...
          {{--  @if ($ndaIn->active == 1)
           ...
           <!--price-->
                   <div class="col-lg-6">
                    <div class="form-element mb-4">
                       <!-- <label>{{__('Price')}} <span>***</span></label>-->
                        <input name="price" type="hidden" value="{{$package->price}}">
                    </div>
                 </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <button type="submit" name="button">{{__('Payumoney')}}</button>
              </div>
            </div>
          </form>
        </div>
